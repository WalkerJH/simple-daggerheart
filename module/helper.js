export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("simple-daggerheart", "macroShorthand");
  ...
  static async createDialog(data = {}, options = {}) {
    ...
    const templates = collection.filter((a) =>
      a.getFlag("simple-daggerheart", "isTemplate")
    );
    const defaultType =
    ...
    return Dialog.prompt({
      ...
      callback: (html) => {
        ...
        if (template) {
          ...
          delete createData.flags.simpleDaggerheart.isTemplate;
        }
